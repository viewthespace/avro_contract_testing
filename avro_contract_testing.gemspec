...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ['tabdollahi']
  spec.email         = ['tania.abdollahi@vts.com']

  spec.summary       = 'Avro contract testing'
  spec.description   = 'Avro contract testing'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/tabdollahi/avro_contract_testing'
  else
